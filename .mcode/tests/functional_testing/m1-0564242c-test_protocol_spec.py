...
Generated at: 2026-03-01T21:29:33.789255+00:00
Project: solidus
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/api/users",
        "method": "GET",
        "description": "List users with valid admin API key, expect paginated results",
        "request_data": {
            "path": {},
            "query": {
                "page": 1,
    ...
    },
    {
        ...
        "endpoint": "/api/users",
        "method": "GET",
        "description": "List users without API key, expect 401 unauthorized",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "list_users_invalid_api_key",
        "category": "AUTH",
        "endpoint": "/api/users",
        "method": "GET",
        "description": "List users with invalid API key, expect 401 unauthorized",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/api/users",
        "method": "POST",
        "description": "Create a new user with valid data and admin API key",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/api/users",
        "method": "POST",
        "description": "Create user without email, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/api/users",
        "method": "POST",
        "description": "Create user without API key, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/users/{id}",
        "method": "GET",
        "description": "Create a user, then retrieve it by ID, then delete it",
        "setup": {
            "endpoint": "/api/users",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/api/users/{id}",
        "method": "GET",
        "description": "Get a user with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/users/{id}",
        "method": "PUT",
        "description": "Create a user, update their email, then delete",
        "setup": {
            "endpoint": "/api/users",
            "method": "POST",
            "headers": {
            ...
            "body": {
                "user": {
                    "email": "testuser_update_before@example.com",
                    "password": "${TEST_USER_PASSWORD}",
                    "password_confirmation": "${TEST_USER_PASSWORD}"
                }
            },
        ...
        "request_data": {
            ...
            "body": {
                "user": {
                    "email": "testuser_update_after@example.com"
                }
            }
        },
        "expected_status": 200,
    ...
    },
    {
        ...
        "endpoint": "/api/users/{id}",
        "method": "DELETE",
        "description": "Create a user then delete it, expect 204",
        "setup": {
            "endpoint": "/api/users",
            "method": "POST",
            "headers": {
    ...
    },
    {
        ...
        "endpoint": "/api/users/{id}",
        "method": "DELETE",
        "description": "Delete a user with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List countries without authentication, expect paginated results from seeded data",
        "request_data": {
            "path": {},
            "query": {
                "page": 1,
    ...
    {
        "name": "list_countries_search",
        "category": "HAPPY_PATH",
        "endpoint": "/api/countries",
        "method": "GET",
        "description": "Search countries by name using Ransack, expect filtered results",
        "request_data": {
            "path": {},
            "query": {
                "q[name_cont]": "United"
    ...
    {
        "name": "get_country_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/countries/{id}",
        "method": "GET",
        "description": "Get a seeded country by ID (US is typically ID 1 or available from listing), including its states",
        "setup": {
            "endpoint": "/api/countries",
            "method": "GET",
            "extract_id_from": "countries.0.id"
        },
        "request_data": {
            "path": {
                "id": "$setup_id"
    ...
    {
        "name": "get_country_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/api/countries/{id}",
        "method": "GET",
        "description": "Get a country with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/states",
        "method": "GET",
        "description": "List all states without authentication",
        "request_data": {
            "path": {},
            "query": {
                "page": 1,
    ...
    {
        "name": "get_state_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/states/{id}",
        "method": "GET",
        "description": "Get the first state from the list, then retrieve it by ID",
        "setup": {
            "endpoint": "/api/states",
            "method": "GET",
            "query": {
    ...
    {
        "name": "get_state_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/api/states/{id}",
        "method": "GET",
        "description": "Get a state with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "endpoint": "/api/countries/{country_id}/states",
        "method": "GET",
        "description": "List states for the first available country from seeded data",
        "setup": {
            "endpoint": "/api/countries",
            "method": "GET",
            "query": {
    ...
    {
        "name": "list_country_states_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/api/countries/{country_id}/states",
        "method": "GET",
        "description": "List states for a non-existent country, expect 404",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/api/stores",
        "method": "GET",
        "description": "List all stores with admin authentication",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "list_stores_unauthorized",
        "category": "AUTH",
        "endpoint": "/api/stores",
        "method": "GET",
        "description": "List stores without API key, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/stores",
        "method": "POST",
        "description": "Create a new store with valid data and admin API key",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "create_store_missing_required",
        "category": "MISSING_REQUIRED",
        "endpoint": "/api/stores",
        "method": "POST",
        "description": "Create store without required name, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
            ...
            "body": {
                "store": {
                    "url": "incomplete.example.com",
                    "code": "incomplete-store",
    ...
    },
    {
        ...
        "endpoint": "/api/stores/{id}",
        "method": "GET",
        "description": "Create a store, retrieve it by ID, then delete it",
        "setup": {
            "endpoint": "/api/stores",
            "method": "POST",
            "headers": {
            ...
            "body": {
                "store": {
                    "name": "Get Test Store",
                    "url": "gettest.example.com",
                    "code": "get-test-001",
                    "mail_from_address": "gettest@example.com",
                    "default_currency": "USD"
                }
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/stores/{id}",
        "method": "GET",
        "description": "Get a store with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    {
        "name": "update_store_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/stores/{id}",
        "method": "PUT",
        "description": "Create a store, update its name, then delete it",
        "setup": {
            "endpoint": "/api/stores",
            "method": "POST",
            "headers": {
            ...
            "body": {
                "store": {
                    ...
                    "url": "updatetest.example.com",
                    "code": "update-test-001",
                    "mail_from_address": "update@example.com",
                    "default_currency": "USD"
                }
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/stores/{id}",
        "method": "DELETE",
        "description": "Create a store then delete it, expect 204",
        "setup": {
            "endpoint": "/api/stores",
            "method": "POST",
            "headers": {
            ...
            "body": {
                "store": {
                    ...
                    "url": "deletetest.example.com",
                    "code": "delete-test-001",
                    "mail_from_address": "delete@example.com",
                    "default_currency": "USD"
                }
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/zones",
        "method": "GET",
        "description": "List zones with admin authentication and pagination",
        "request_data": {
            "path": {},
            "query": {
                "page": 1,
    ...
    {
        "name": "list_zones_unauthorized",
        "category": "AUTH",
        "endpoint": "/api/zones",
        "method": "GET",
        "description": "List zones without API key, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/zones",
        "method": "POST",
        "description": "Create a new zone with admin API key",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
            ...
            "body": {
                "zone": {
                    "name": "Test Zone for API",
                    "description": "A test zone created via API"
                }
            }
        },
        "expected_status": 201,
    ...
    },
    {
        ...
        "endpoint": "/api/zones",
        "method": "POST",
        "description": "Create zone without required name, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "get_zone_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/zones/{id}",
        "method": "GET",
        "description": "Create a zone, retrieve it by ID, then delete it",
        "setup": {
            "endpoint": "/api/zones",
            "method": "POST",
            "headers": {
    ...
    {
        "name": "get_zone_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/api/zones/{id}",
        "method": "GET",
        "description": "Get a zone with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/zones/{id}",
        "method": "PUT",
        "description": "Create a zone, update its name, then delete it",
        "setup": {
            "endpoint": "/api/zones",
            "method": "POST",
            "headers": {
            ...
            "body": {
                "zone": {
                    ...
                    "description": "Zone for update test"
                }
            },
            "extract_id_from": "id"
        },
        ...
        "setup": {
            ...
            "body": {
                "zone": {
                    ...
                    "description": "Zone for delete test"
                }
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/api/zones/{id}",
        "method": "DELETE",
        "description": "Delete a zone with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999999
            },
    ...
    {
        "name": "get_config_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/config",
        "method": "GET",
        "description": "Get configuration with valid API key, expect default_country_iso in response",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "get_config_unauthorized",
        "category": "AUTH",
        "endpoint": "/api/config",
        "method": "GET",
        "description": "Get configuration without API key, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get money configuration with valid API key, expect currency symbol in response",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "get_money_config_unauthorized",
        "category": "AUTH",
        "endpoint": "/api/config/money",
        "method": "GET",
        "description": "Get money configuration without API key, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "get_my_store_credit_events_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/store_credit_events/mine",
        "method": "GET",
        "description": "Get store credit events for authenticated user, expect paginated empty list or events",
        "request_data": {
            "path": {},
            "query": {},
            "headers": {
    ...
    {
        "name": "get_my_store_credit_events_unauthorized",
        "category": "AUTH",
        "endpoint": "/api/store_credit_events/mine",
        "method": "GET",
        "description": "Get store credit events without authentication, expect 401",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
